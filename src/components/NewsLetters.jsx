...
<span className='text-white'>
    Singn up to our newsletter and up to date.
        ...
        <input type="text"  className='sm:w-full rounded mb-2s p-3 mr-2 text-slate-600' placeholder='Email'/>
        <button className='bg-black text-white w-[200px] rounded-md font-medium my-6  mx-auto md:mx-0 py-3'>Get Started</button>
        <br/>
        <p className='text-white'>
            We Care bout protection of your data. our <br/> <a href="" className='text-black'> Privacy Policy.</a> 
        </p>
        </div>
